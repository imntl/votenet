...
def dump_results(end_points, dump_dir, config, inference_switch=False):
    ...
    pred_heading_class = torch.argmax(end_points['heading_scores'], 2) # B,num_proposal
    pred_heading_residual = torch.gather(end_points['heading_residuals'], 2, pred_heading_class.unsqueeze(2))
